...
namespace WalkingDead.Controllers
{
    ...
    public class TestsController : ControllerBase
    {
        ...
        {
            return await _context.WalkingDeadItems.ToListAsync();
        }
        ...
        {
            var test = await _context.WalkingDeadItems.FindAsync(id);
        ...
        {
            _context.WalkingDeadItems.Add(test);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Test>> DeleteTest(long id)
        {
            ...
            _context.WalkingDeadItems.Remove(test);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.WalkingDeadItems.Any(e => e.Id == id);
        }
    }
}
